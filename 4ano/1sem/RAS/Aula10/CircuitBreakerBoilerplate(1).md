...
public class ExternalFilterService {
    ...
    public Image applyPremiumFilter(Image image, String filterType) {
        ...
        return circuitBreaker.call(() -> filterAPI.applyFilter(image, filterType),
                                   () -> {
                                       System.out.println("Fallback: Returning original image due to service unavailability.");
                                       return image; // Fallback returns the original image
                                   });
